...
V_batt_min = 3.1 # Minimum V of battery to Trigger Emailed BatteryMonitor Report.
...
#====================================================================================
        ...
        if ( Vin < V_in_min ): # Vin has failed or is a brownout
                if (Vbattery < V_batt_min ): # Battery is low, time to shutdown.
                        ...
                        emailCoreData = "PiUptimeUps:: Vin: {:.2f}, Vbattery: {:.2f}, TempC: {:.2f}, TempF: {:.2f}".format(Vin, Vbattery, TempC, TempF)
