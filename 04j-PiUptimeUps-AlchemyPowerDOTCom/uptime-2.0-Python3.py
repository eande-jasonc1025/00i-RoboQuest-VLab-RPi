...
# jwc used to identify Rpi for Emailed Battery-Monitor Report
hostName_Str = os.uname()[1]

# jwc adjust for BatteryMonitor-Report
#     LiIon V Range: Max: 4.27v-3.70v = avg 3.985v, Min 3.0v
#     \ so halfway threshold roughly = 3.5 to Trigger Emailed Battery-Monitor Report
##jwc o V_batt_min = 3.1 # Halfway-Depleted V of battery at which time shutdown is triggered.
V_batt_min = 3.5 # Halfway-Depeted V of battery to Trigger Emailed Battery-Monitor Report.

##jwc o zeit = 1     # number of seconds to sleep between each measurement group. This will read variables every 20 seconds.
##jwc y zeit = 5     # number of seconds to sleep between each measurement group. This will read variables every 20 seconds.
zeit = 60     # number of seconds to sleep between each measurement group. This will read variables every 20 seconds.

# ----- -----
# jwc
#

# Taken from 'email-SmtpLib-Test.py
#
import smtplib
...
# Battery V
#=========================================================================================================
##jwc o V_batt_min = 3.1 # Minimum V of battery at which time shutdown is triggered.
...
#====================================================================================
        ...
        if ( Vin < V_in_min ): # Vin has failed or is a brownout
                if (Vbattery < V_batt_min ): # Battery is low, time to shutdown.
                        ...
                        emailCoreData = hostName_Str + ":: PiUptimeUps:: Vin: {:.2f}, Vbattery: {:.2f}, TempC: {:.2f}, TempF: {:.2f}".format(Vin, Vbattery, TempC, TempF)
                        emailSubject = "Subject: " + emailCoreData
                        emailContent = "Content: " + emailCoreData
                        print( "*** " + emailSubject )
                        print( "*** " + emailContent )
